...
public class NachalnikIGRI : MonoBehaviour
{
    public static NachalnikIGRI instance;
    
    private NachalnikUI _nachalnikUI;
    ...
    [Inject]
    public void Construct(NachalnikUI nachalnikUI)
    {
        _nachalnikUI = nachalnikUI;
    }
